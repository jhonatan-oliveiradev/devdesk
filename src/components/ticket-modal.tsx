    ...
    <Dialog open onOpenChange={handleModalVisible}>
      <DialogContent>
        <DialogHeader>
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap">
              <p>
                <span className="mr-1 font-bold text-primary">Nome:</span>
                {ticket?.ticket.name}
              </p>
            </div>
            <div>
              <p>
                <span className="mr-1 font-bold text-primary">Descrição:</span>
                {ticket?.ticket.description}
              </p>
            </div>
            <div className="flex flex-col items-center justify-between md:flex-row">
              <p className="text-sm">
                <span className="mr-1 font-bold text-primary">Status:</span>
                <Badge
                  className="text-xs"
                  variant={
        ...
        <div className="space-y-4">
          ...
          <div>
            <p>
              <span className="mr-1 font-bold text-primary">Email:</span>
              {ticket?.customer?.email}
            </p>
          </div>
          <div>
            <p>
              <span className="mr-1 font-bold text-primary">Telefone:</span>
              {formattedPhone}
            </p>
          </div>
          {ticket?.customer?.address && (
            <div>
              <p>
                <span className="mr-1 font-bold text-primary">Endereço:</span>
                {ticket?.customer?.address}
              </p>
            </div>
          )}
